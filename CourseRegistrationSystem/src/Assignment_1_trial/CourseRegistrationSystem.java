...
public class CourseRegistrationSystem {
    ...
    private void markCourseCompleted() {
        try {
            ...
            System.out.print("Enter the course code to mark as completed: ");
            String courseCode = scanner.nextLine();
            if (courseCode.trim().isEmpty()) {
                throw new IllegalArgumentException("Course code cannot be empty.");
            }
            ...
            if (course == null || !student.getEnrolledCourses().contains(course)) {
                throw new IllegalArgumentException("Course not found or student is not enrolled.");
            }

            double grade = getDoubleInput("Enter the grade for the completed course: ");
            student.markCourseCompleted(course, grade);
            System.out.println("Course marked as completed and CGPA updated.");
        } catch (IllegalArgumentException e) {
            System.out.println("Failed to mark course as completed: " + e.getMessage());
        } catch (Exception e) {
            System.out.println("An unexpected error occurred while marking the course as completed: " + e.getMessage());
        }
    }
